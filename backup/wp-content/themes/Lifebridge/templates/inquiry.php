<?php 
/* Template Name: First Inquiry Template
*/ 
get_header(); 
...
if($_REQUEST['actions']=="inquirey"){
    ...
    if($record_id){
     ...
     echo '<script type="text/javascript">window.location.href = "home_url()/list-of-inquiry-form/"</script>'; 
    }
}
?>
...
<?php /*} else{
  ...
  <div class="card-body">
    ...
    <button class="btn btn-primary">Inquiries Reports</button>
    <button class="btn btn-primary">Appointment Reports</button>
  </div>
