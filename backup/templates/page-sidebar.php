                      ...
                      <div class="profileMenu">
                        <ul class="sideNav">
                          <li id="navigationItem">
                            <a href="<?php echo site_url();?>/inquiry/"><span class="imgWrap"></span><span><i class="fa fa-user" aria-hidden="true"></i> Inquiry</span></a>
                          </li> 

                          <li id="navigationItem">
                            <a href="<?php echo site_url();?>/list-of-inquiry-form/"><span class="imgWrap"></span><span><i class="fa fa-user" aria-hidden="true"></i>List Of Inquiry</span></a>
                          </li> 
