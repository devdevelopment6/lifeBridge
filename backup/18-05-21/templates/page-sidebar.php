                      ...
                      <div class="profileMenu">
                        ...
                        <?php  if ( in_array( 'usera', $user_roles, true ) ) { ?>
                          <li id="navigationItem">
                            <a href="<?php echo site_url();?>/inquiry/"><span class="imgWrap"></span><span><i class="fa fa-user" aria-hidden="true"></i>Create Inquiry</span></a>
                          </li> 
                        <?php } ?>

                        <?php  if ( in_array( 'userb', $user_roles, true ) ) { ?>
                          <li id="navigationItem">
                            <a href="<?php echo site_url();?>/appointment/"><span class="imgWrap"></span><span><i class="fa fa-user" aria-hidden="true"></i> Create Appointment</span></a>
                          </li>  
                          <li id="navigationItem">
                            <a href="<?php echo site_url();?>/list-of-appointment/"><span class="imgWrap"></span><span><i class="fa fa-user" aria-hidden="true"></i> List Appointment</span></a>
                          </li> 
                        <?php } ?>
